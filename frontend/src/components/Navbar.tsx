...
import { Lock, Sun, Moon, ChevronDown, BookOpen, LayoutDashboard, User, LogOut, Shield, Trash2, Menu, X, ShieldCheck } from 'lucide-react';
...
// Vault Icon (using ShieldCheck as a better semantic fit)
const VaultIcon = () => <ShieldCheck className="w-4 h-4" />;
