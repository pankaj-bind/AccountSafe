...
import { MoreVertical, Pencil, Trash2, ExternalLink, Key, Plus } from 'lucide-react';
    ...
    >
      ...
      <div className="flex items-center justify-center h-12 sm:h-14 mb-2 sm:mb-3">
        {docMatch ? (
          ...
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-500/10 border border-blue-500/20 rounded-lg sm:rounded-xl flex items-center justify-center">
            <span className="text-lg sm:text-xl font-bold text-blue-500">
              {org.name ? org.name.charAt(0).toUpperCase() : 'AS'}
            </span>
          </div>
        )}
      </div>
