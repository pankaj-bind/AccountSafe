...
// Components
import CategorySection, { ViewMode } from './CategorySection';
          ...
          <div className="flex flex-col gap-4">
            <div>
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                <div className="p-2 sm:p-2.5 bg-blue-500/10 rounded-lg sm:rounded-xl border border-blue-500/20 flex items-center justify-center">
                  <span className="text-blue-500 font-bold text-sm sm:text-base leading-none">AS</span>
                </div>
                ...
                {docMatch ? (
                  ...
                  <div className="w-full h-full bg-blue-500/10 rounded-lg flex items-center justify-center">
                    <span className="text-blue-500 font-bold text-2xl">
                      {newOrg.name ? newOrg.name.charAt(0).toUpperCase() : 'AS'}
                    </span>
                  </div>
                )}
              </div>
