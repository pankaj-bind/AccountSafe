...
import { ExternalLink, ChevronRight, Key, Pencil, Trash2 } from 'lucide-react';
    ...
    >
      ...
      <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center">
        {docMatch ? (
          ...
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-500/10 border border-blue-500/20 rounded-lg flex items-center justify-center">
